...
class createinternationalpost extends StatefulWidget {
  @override
  _createinternationalpostState createState() =>
      _createinternationalpostState();
}

class _createinternationalpostState extends State<createinternationalpost> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            DropdownButton(
              ...
              items: ["InternationalAllNews"].map(
                (val) {
